...
URL = 'https://www.youtube.com/watch?v=FHPszRvL9pg'
YT_DLP_OPTIONS = {
  'quiet': True,
...
class Video:
  ...
  def raw_video_cache_path(self):
    return os.path.join(CACHE, self.id + '_raw.' + self.info()['ext'])
  ...
  def processed_video(self):
    ...
    FFmpeg().option("y").input(self.raw_video()).output(
      output_path,
...
if __name__ == '__main__':
  print(Video(URL).processed_video())
