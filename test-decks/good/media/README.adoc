...
I forked Yusuf Sezer's https://www.yusufsezer.com/analog-clock/[analog clock demo] and turned it into a https://github.com/danielparks/analog-clock[stopwatch].
