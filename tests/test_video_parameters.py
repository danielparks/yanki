...
def test_time_parse(tmp_path):
  ...
  assert round(video.time_to_seconds('1:23:45.6'), 9) == (1*60 + 23)*60 + 45.6
  assert round(video.time_to_seconds('02:03:05.6'), 9) == (2*60 + 3)*60 + 5.6
  ...
  assert round(video.time_to_seconds('2.1:3:5.6'), 9) == (2.1*60 + 3)*60 + 5.6
