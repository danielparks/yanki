...
def test_easy_url():
  assert find_url('foo bar https://example.com/?q=abc&t=1#fragment hey') \
    == 'https://example.com/?q=abc&t=1#fragment'

def test_easy_url_empty_fragment():
  assert find_url('foo bar https://example.com/?q=abc&t=1# hey') \
...
def test_newline_url():
  assert find_url('foo bar\nhttps://example.com/?q=abc&t=1#fragment\nhey') \
    == 'https://example.com/?q=abc&t=1#fragment'

def test_bare_url():
  assert find_url('https://example.com/?q=abc&t=1#fragment') \
    == 'https://example.com/?q=abc&t=1#fragment'

def test_bare_url_empty_fragment():
  assert find_url('https://example.com/?q=abc&t=1#') \
    == 'https://example.com/?q=abc&t=1#'

def test_trailing_comma():
  assert find_url('foo https://example.com/?q=abc&t=1, bar') \
    == 'https://example.com/?q=abc&t=1'
